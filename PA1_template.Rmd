...
weekday_plot <- plot(avgbyinterval_weekday, type = "l", main = "Steps per Day during Weekdays", col = "red", xlab = "Interval (every 5 minutes)", ylab = "Average Number of Steps")

weekend_plot <- plot(avgbyinterval_weekend, type = "l", main = "Steps per Day during Weekends", col = "blue", xlab = "Interval (every 5 minutes)", ylab = "Average Number of Steps")
```
